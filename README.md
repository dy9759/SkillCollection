...
`news-to-note`、`tag-organize`、`note-copilot`、`live-transcript-summary`、`coding-assistant`、`literature-reader`、`wpsnote-beautifier` 等目录聚焦具体任务流程，复用 `wps-note` 的 MCP 或 CLI 能力完成业务目标。
