...
在调用任何 MCP 工具之前，**必须先用一句话告知用户正在做什么**，不允许沉默直接调用工具。

示例：
- "好的，我先去笔记里搜索一下有没有这部小说的设定..."
- "正在读取上一章的结尾，稍等..."
- "现在开始创建世界观笔记..."
- "第三章已写好，正在存入笔记..."
- "更新一下剧情日志..."

归档阶段（归档 1–5）可以合并说一句："正在存档，更新日志和角色状态..."，不需要每步都说。
...
> **铁律：所有正文内容必须通过 WPS 笔记 MCP 工具写入笔记，不得在对话中直接输出小说正文。**
